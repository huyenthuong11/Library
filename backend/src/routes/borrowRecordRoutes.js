...
router.get("/getBorrowRecord", authMiddleware, checkRole(["admin", "librarian"]), async(req, res) => {
    try {
...
router.get("/getBorrowRecordByReader", authMiddleware, checkRole(["reader"]), async(req, res) => {
    try {
...
router.get("/getBorrowRecordByCopy", authMiddleware, checkRole(["admin", "librarian"]), async(req, res) => {
    try {
